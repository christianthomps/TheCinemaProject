...
public class Seat {
	...
	private int isOpen; //is the seat open 

	private static final String TEST = "jdbc:mysql://127.0.0.1:3306/Project?user=root&password=June201998";
	...
	public void addSeatToDB() {
		...
		try {
			...
			String query = "INSERT into Seat(seatID, atShowing, isOpen) values(?, ?, ?)";
			pstmt = con.prepareStatement(query);
